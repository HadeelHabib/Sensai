  ...
  return (
    <div className="md:w-[95%] mx-auto my-[10%] text-center">
      ...
      <div className="md:flex items-center justify-around">
        ...
        <Image className="absolute left-[10px] bottom-[-95%] " src={IMGS.shape4} alt="" />
          ...
          <p className="max-w-[330px] text-[var(--text-color)]">
        ...
        <div className="relative bg-[#f9f6ff] rounded-[10px] p-[40px] mb-[32px]">
          <div className="bg-white rounded-[5px] shadow-md px-[20px] py-[18px]">
            ...
            <Image className="absolute right-[40px] bottom-[30px]" src={IMGS.icon1} alt="" />
          </div>
        </div>
        ...
        <div className="relative bg-[#f9f6ff] rounded-[10px] p-[40px] mb-[32px]">
            ...
            <Image className="rounded-[5px] shadow-md overflow-hidden" src={IMGS.working} alt="" />
